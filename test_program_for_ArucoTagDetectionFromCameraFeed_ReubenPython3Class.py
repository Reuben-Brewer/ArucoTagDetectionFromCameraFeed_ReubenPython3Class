...
if __name__ == '__main__':
    ...
    '''
    for ID_integer in range(0,50):
        print(ID_integer)
        ArucoTagDetectionFromCameraFeed_ReubenPython3ClassObject.CreateAndSaveImageOfArucoTagMarker(ID_integer=ID_integer, ArucoTag_DictType_EnglishString = "",EdgeLengthInPixels_integer = 1000)
    '''

    #ArucoTagDetectionFromCameraFeed_ReubenPython3ClassObject.CreateAndSaveImageOfArucoTagMarker(ID_integer=49, ArucoTag_DictType_EnglishString = "",EdgeLengthInPixels_integer = 1000)
    #ArucoTagDetectionFromCameraFeed_ReubenPython3ClassObject.CreateAndSaveImageOfArucoTagMarker(ID_integer=7, ArucoTag_DictType_EnglishString = "",EdgeLengthInPixels_integer = 1000)
    #EXIT_PROGRAM_FLAG = 1
